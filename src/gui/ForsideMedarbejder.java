...
public class ForsideMedarbejder extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ForsideMedarbejder frame = new ForsideMedarbejder();
	...
	public ForsideMedarbejder() {
		...
		JButton btnTagVagt = new JButton("Tag en vagt");
		btnTagVagt.setBounds(20, 162, 150, 30);
		contentPane.add(btnTagVagt);
