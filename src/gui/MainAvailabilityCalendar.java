...
public class MainAvailabilityCalendar extends JFrame {

	private JPanel contentPane;
	private AvailabilityCalendar calendarAvailability;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainAvailabilityCalendar frame = new MainAvailabilityCalendar();
	 ...
	 */
	public MainAvailabilityCalendar() throws DataAccessException {
		setUIStyle();
		initComponents();
	}
	    ...
	    jPanel1Layout.setHorizontalGroup(
	    	jPanel1Layout.createParallelGroup(Alignment.LEADING)
	    		.addGroup(Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
	    			.addContainerGap()
	    			.addComponent(calendarAvailability, GroupLayout.DEFAULT_SIZE, 1036, Short.MAX_VALUE)
	    			.addContainerGap())
	    );
	    jPanel1Layout.setVerticalGroup(
	    	jPanel1Layout.createParallelGroup(Alignment.LEADING)
	    		.addGroup(jPanel1Layout.createSequentialGroup()
	    			.addContainerGap()
	    			.addComponent(calendarAvailability, GroupLayout.DEFAULT_SIZE, 768, Short.MAX_VALUE)
	    			.addContainerGap())
	    );
